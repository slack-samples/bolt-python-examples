...
- **[Card](https://docs.slack.dev/reference/block-kit/blocks/card-block)**: Displays a container for related content with an optional image, title, body, and actions. [Implementation](./src/blocks/card.py).
